...
{
    public class NetworkOVRHandMapper : NetworkPoseMapper<OVRHandMapper>
    {
        ...
        protected override void Observe(OVRHandMapper observable)
        {
            observable.AddObserver(this);
        }
        protected override void Unobserve(OVRHandMapper observable)
        {
